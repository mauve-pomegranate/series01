const artifactsData = {
    "Ichiro Kobayashi's Special Tarot Deck": {
        items: [
            {
    ...
    "Sørensen's Scavenged Energy Measurement Device": {
        items: [
            {
